...
async function createTokens() {
  ...
  console.log("eAUD")
  console.log(await NetworkDriver.createStableCoin(coinbase, privateKey, (NetworkDriver.fileToJSON('build/contracts/StableCoin.json')).bytecode, (await NetworkDriver.encodeParameters(["Australian Dollar", "eAUD", "2", "100000"])).slice(2)))
  console.log("eCAD")
  console.log(await NetworkDriver.createStableCoin(coinbase, privateKey, (NetworkDriver.fileToJSON('build/contracts/StableCoin.json')).bytecode, (await NetworkDriver.encodeParameters(["Canadian Dollar", "eCAD", "2", "100000"])).slice(2)))
  console.log("eCNY")
  console.log(await NetworkDriver.createStableCoin(coinbase, privateKey, (NetworkDriver.fileToJSON('build/contracts/StableCoin.json')).bytecode, (await NetworkDriver.encodeParameters(["Chinese Yuan", "eCNY", "2", "100000"])).slice(2)))
  console.log("eEUR")
  console.log(await NetworkDriver.createStableCoin(coinbase, privateKey, (NetworkDriver.fileToJSON('build/contracts/StableCoin.json')).bytecode, (await NetworkDriver.encodeParameters(["Euro", "eEUR", "2", "100000"])).slice(2)))
  console.log("eGBP")
  console.log(await NetworkDriver.createStableCoin(coinbase, privateKey, (NetworkDriver.fileToJSON('build/contracts/StableCoin.json')).bytecode, (await NetworkDriver.encodeParameters(["Pound Sterling", "eGBP", "2", "100000"])).slice(2)))
  console.log("eIDR")
  console.log(await NetworkDriver.createStableCoin(coinbase, privateKey, (NetworkDriver.fileToJSON('build/contracts/StableCoin.json')).bytecode, (await NetworkDriver.encodeParameters(["Indonesian Rupiah", "eIDR", "2", "100000"])).slice(2)))
  console.log("eJPY")
  console.log(await NetworkDriver.createStableCoin(coinbase, privateKey, (NetworkDriver.fileToJSON('build/contracts/StableCoin.json')).bytecode, (await NetworkDriver.encodeParameters(["Japanese Yen", "eJPY", "0", "100000"])).slice(2)))
  console.log("ePHP")
  console.log(await NetworkDriver.createStableCoin(coinbase, privateKey, (NetworkDriver.fileToJSON('build/contracts/StableCoin.json')).bytecode, (await NetworkDriver.encodeParameters(["Philippine Peso", "ePHP", "2", "100000"])).slice(2)))
  console.log("eSGD")
  console.log(await NetworkDriver.createStableCoin(coinbase, privateKey, (NetworkDriver.fileToJSON('build/contracts/StableCoin.json')).bytecode, (await NetworkDriver.encodeParameters(["Singapore Dollar", "eSGD", "2", "100000"])).slice(2)))
  console.log("eUSD")
  console.log(await NetworkDriver.createStableCoin(coinbase, privateKey, (NetworkDriver.fileToJSON('build/contracts/StableCoin.json')).bytecode, (await NetworkDriver.encodeParameters(["US Dollar", "eUSD", "2", "3000000"])).slice(2)))
}
