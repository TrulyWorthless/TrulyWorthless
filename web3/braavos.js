...
async function createTokens() {
  ...
  console.log("eAUD")
  console.log(await BraavosDriver.createStableCoin(coinbase, privateKey, (BraavosDriver.fileToJSON('build/contracts/StableCoin.json')).bytecode, (await BraavosDriver.encodeParameters(["Australian Dollar", "eAUD", "6", "0"])).slice(2)))
  console.log("eCAD")
  console.log(await BraavosDriver.createStableCoin(coinbase, privateKey, (BraavosDriver.fileToJSON('build/contracts/StableCoin.json')).bytecode, (await BraavosDriver.encodeParameters(["Canadian Dollar", "eCAD", "6", "0"])).slice(2)))
  console.log("eCNY")
  console.log(await BraavosDriver.createStableCoin(coinbase, privateKey, (BraavosDriver.fileToJSON('build/contracts/StableCoin.json')).bytecode, (await BraavosDriver.encodeParameters(["Chinese Yuan", "eCNY", "6", "0"])).slice(2)))
  console.log("eEUR")
  console.log(await BraavosDriver.createStableCoin(coinbase, privateKey, (BraavosDriver.fileToJSON('build/contracts/StableCoin.json')).bytecode, (await BraavosDriver.encodeParameters(["Euro", "eEUR", "6", "0"])).slice(2)))
  console.log("eGBP")
  console.log(await BraavosDriver.createStableCoin(coinbase, privateKey, (BraavosDriver.fileToJSON('build/contracts/StableCoin.json')).bytecode, (await BraavosDriver.encodeParameters(["Pound Sterling", "eGBP", "6", "0"])).slice(2)))
  console.log("eIDR")
  console.log(await BraavosDriver.createStableCoin(coinbase, privateKey, (BraavosDriver.fileToJSON('build/contracts/StableCoin.json')).bytecode, (await BraavosDriver.encodeParameters(["Indonesian Rupiah", "eIDR", "6", "0"])).slice(2)))
  console.log("eJPY")
  console.log(await BraavosDriver.createStableCoin(coinbase, privateKey, (BraavosDriver.fileToJSON('build/contracts/StableCoin.json')).bytecode, (await BraavosDriver.encodeParameters(["Japanese Yen", "eJPY", "6", "0"])).slice(2)))
  console.log("ePHP")
  console.log(await BraavosDriver.createStableCoin(coinbase, privateKey, (BraavosDriver.fileToJSON('build/contracts/StableCoin.json')).bytecode, (await BraavosDriver.encodeParameters(["Philippine Peso", "ePHP", "6", "0"])).slice(2)))
  console.log("eSGD")
  console.log(await BraavosDriver.createStableCoin(coinbase, privateKey, (BraavosDriver.fileToJSON('build/contracts/StableCoin.json')).bytecode, (await BraavosDriver.encodeParameters(["Singapore Dollar", "eSGD", "6", "0"])).slice(2)))
  console.log("eUSD")
  console.log(await BraavosDriver.createStableCoin(coinbase, privateKey, (BraavosDriver.fileToJSON('build/contracts/StableCoin.json')).bytecode, (await BraavosDriver.encodeParameters(["US Dollar", "eUSD", "6", "0"])).slice(2)))
}
